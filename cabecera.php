...
<body >
    ...
    <div>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTft62JtZz86ScQk8XU9c8NOKxnBj1e_FgQHnJz8Mp-bTi_2Gh4EA" class="imagen-central"  alt="">
    </div>
    ...
    <div class="container mb-5 tablilla" id="tabla" >
        <table class="table table-sm mb-5 table-bordered">
          ...
          <tbody>
            <tr>
              <td scope="row" class="text-right" colspan="3">Total a cancelar</td> 
