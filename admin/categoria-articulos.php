...
<div class="container">
    <div class=""> 
        <p class="text-center">
            ...
            <a class="categoria" href="categoria-articulos.php?categoria=zapatos">Zapatos</a>
            <a class="categoria" href="categoria-articulos.php?categoria=lentes">Lentes</a>
        </p>
    </div>
    <h3 id="titulo-categoria"><?php echo $categoria ?></h3>
